...
function QvickLogoIcon() {
  return (
    <svg viewBox="0 0 87 87" fill="none" xmlns="http://www.w3.org/2000/svg" className="qvick-logo">
      ...
      <path d="M48.5895 0C48.5895 9.04185 53.1652 18.5357 60.5058 25.8763C67.8464 33.2169 77.3403 37.7918 86.3822 37.7918L86.3822 48.5894C73.8286 48.5893 61.7267 42.3674 52.8707 33.5113C44.0147 24.6553 37.7929 12.5538 37.7929 0.000186511L48.5895 0Z" fill="url(#paint0_linear_patchnote)"/>
      <defs>
        <linearGradient id="paint0_linear_patchnote" x1="39.0554" y1="4.24454" x2="82.8" y2="46.8675" gradientUnits="userSpaceOnUse">
...
export default function PatchNotePage() {
  ...
  const handleSelectNote = (note: PatchNote) => {
    ...
    navigate(`/patchnote/${note.id}`, { replace: true });
  };
                ...
                <article className="patchnote-article">
                  <div className="article-header">
                    <div className="article-meta">
                      ...
                      {selectedNote.visibility === 'teacher' && (
                        <span className="visibility-badge teacher">
                          {VISIBILITY_CONFIG.teacher.icon} {VISIBILITY_CONFIG.teacher.label}
                        </span>
                      )}
                    </div>
